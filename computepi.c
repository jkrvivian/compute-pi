...
double compute_pi_Leibnizavx_unroll(size_t N)
{
    ...
    ymm0 = _mm256_set1_pd(1.0);
    ymm1 = _mm256_set1_pd(2.0);
    ymm10 = _mm256_set_pd(-1.0,1.0,-1.0,1.0); //for pow(-1,i)
    ymm6 = _mm256_setzero_pd();             // first sum of pi
    ymm7 = _mm256_setzero_pd();             // second sum of pi
    ymm8 = _mm256_setzero_pd();             // third sum of pi
    ymm9 = _mm256_setzero_pd();             // fourth sum of pi
    ...
    for (int i = 0; i <= N - 16; i += 16) {
		...
		ymm2 = _mm256_set_pd(i+3.0, i+2.0, i+1.0, i);
		ymm3 = _mm256_set_pd(i+7.0, i+6.0, i+5.0, i+4.0);
		ymm4 = _mm256_set_pd(i+11.0, i+10.0, i+9.0, i+8.0);
		ymm5 = _mm256_set_pd(i+15.0, i+14.0, i+13.0, i+12.0);
        ...
        ymm5 = _mm256_add_pd(ymm0, ymm5);

        ymm2 = _mm256_div_pd(ymm10, ymm2);
        ymm3 = _mm256_div_pd(ymm10, ymm3);
        ymm4 = _mm256_div_pd(ymm10, ymm4);
        ymm5 = _mm256_div_pd(ymm10, ymm5);
